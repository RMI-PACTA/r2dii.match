...
We use the package r2dii.match to access the most important functions you'll learn about. We also use example datasets from the package r2dii.dataraw, and optional but convenient functions from the tidyverse.
...
```{r child="../man-roxygen/validate-matches.Rmd"}
