...
We need two datasets: a "loanbook" and an "asset-based company dataset" (abcd). These should be formatted like:  [`loanbook_demo`](https://2degreesinvesting.github.io/r2dii.data/reference/loanbook_demo.html) and [`abcd_demo`](https://2degreesinvesting.github.io/r2dii.data/reference/abcd_demo.html) (from the [r2dii.data package](https://2degreesinvesting.github.io/r2dii.data)).
