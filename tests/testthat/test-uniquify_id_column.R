...
test_that("uniquify_id_column errs gracefully w/ bad direct & ultimate levels", {
  ...
  # intermediate is only a warning
  expect_warning(
    loanbook_demo %>%
      invalidate("id_intermediate_parent_1") %>%
      uniquify_id_column(id_column = "id_intermediate_parent_1"),
